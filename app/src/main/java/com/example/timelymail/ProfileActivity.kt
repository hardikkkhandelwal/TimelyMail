    ...
    // 👇 add the navigation listener *here*
            bottomNav.setOnNavigationItemSelectedListener { item ->
                when (item.itemId) {
                    ...
                    R.id.nav_sent -> {
                        supportFragmentManager.beginTransaction()
                            .replace(R.id.fragment_container, InboxFragment.newInstance("SENT"))
                            .commit()
                        toolbarTitle.text = "Sent"
                        true
                    }
                    R.id.nav_drafts -> {
                        supportFragmentManager.beginTransaction()
                            .replace(R.id.fragment_container, InboxFragment.newInstance("DRAFT"))
                            .commit()
                        toolbarTitle.text = "Drafts"
                        true
                    }
                    R.id.nav_archive -> {
                        supportFragmentManager.beginTransaction()
                            .replace(R.id.fragment_container, InboxFragment.newInstance("ARCHIVE"))
                            .commit()
            ...
            // DRAWER NAV ITEMS
            val inboxItem = findViewById<LinearLayout>(R.id.inboxItem)
            val sentItem = findViewById<LinearLayout>(R.id.sentItem)
            val draftItem = findViewById<LinearLayout>(R.id.draftItem)
            val archItem = findViewById<LinearLayout>(R.id.archItem)
            val delItem = findViewById<LinearLayout>(R.id.delItem)

// Set default active item (e.g., Inbox)
            setActiveNavItem(inboxItem)
...
// Click listeners for drawer items
            ...
            sentItem.setOnClickListener {
                setActiveNavItem(sentItem)
                supportFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, InboxFragment.newInstance("SENT"))
                    .commit()
            }

            draftItem.setOnClickListener {
                setActiveNavItem(draftItem)
                supportFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, InboxFragment.newInstance("DRAFT"))
                    .commit()
            }

            archItem.setOnClickListener {
                setActiveNavItem(archItem)
                supportFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, InboxFragment.newInstance("ARCHIVE"))
                    .commit()
            }
            ...
            delItem.setOnClickListener {
                setActiveNavItem(delItem)
                supportFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, InboxFragment.newInstance("DELETED"))
                    .commit()
            }
    ...
    //        }
        ...
        private fun setActiveNavItem(item: LinearLayout) {
            // reset previous highlight
            activeNavItem?.setBackgroundResource(R.drawable.bg_nav_default)
